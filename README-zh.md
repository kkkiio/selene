...
| 包名 | 作用 |
| --- | --- |
| `KKKIIO/selene` | 核心 ECS/运行时模块（`app`、`asset`、`atlas`、`editor_bridge`、`animation`、`scene`、`physics2d/3d`、`render2d/3d`、`ui`、`ui_view`） |
| `KKKIIO/selene_webgpu` | Web 后端实现 |
| `KKKIIO/selene_raylib` | 原生后端实现 |
| `KKKIIO/selene_xaml` | MS-XAML 解析、编译与类型化 View 生成器 |
